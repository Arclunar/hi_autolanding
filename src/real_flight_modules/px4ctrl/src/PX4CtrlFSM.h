...
public:
	...
	ros::Publisher ctrl_FCU_pub; // 订阅 /mavros/setpoint_raw/attitude
	ros::Publisher debug_pub; //debug
	ros::ServiceClient set_FCU_mode_srv; // 设置飞控模式
	ros::ServiceClient arming_client_srv; // 解锁
	ros::ServiceClient reboot_FCU_srv; // 重启
...
private:
	...
	void publish_killmotor_ctrl(const ros::Time &stamp);
